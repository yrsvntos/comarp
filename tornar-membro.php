<?php
/**
 * * * Template Name: Membro
 * 
 * The template for displaying Membro page
 *
...
?>
	...
	<section id="banner-single" style="background: url(<?php echo get_the_post_thumbnail_url(); ?>);">
		<div class="overlay flex-center">
			<div class="container">
				<div class="py-5">
					<h1 class="fw-bold text-center">Seja Membro</h1>
				</div>
			</div>
		</div>
	</section>
	...
	<section id="contacto">
		<div class="container">
			<div class="py-5">
				<div class="row">
					<div class="col-md-5">
						<h4 class="text-azul-2 mb-4"><b>Torne-se Membro</b></h4>
						<?php 

					      $args = array( 'post_type' => 'tornar-membro', 'posts_per_page' => 1);
					      $loop = new WP_Query( $args );
					      while ( $loop->have_posts() ) : $loop->the_post();  
